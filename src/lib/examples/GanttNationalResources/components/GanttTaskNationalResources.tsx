...
} from "./GanttTaskContentNationalResources";
...
const GanttTaskNationalResources = (props: IProps & typeof defaultProps) => {
	// *** PROPS ***
	const {
		gridProps,
		calendarProps,
...
GanttTaskNationalResources.defaultProps = defaultProps;
